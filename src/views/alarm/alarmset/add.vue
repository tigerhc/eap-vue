<template>
  <div class="app-container calendar-list-container">
    <el-form ref="modelForm" :inline="true" :rules="rules" :model="addList" class="modelForm" label-width="90px">
      <el-row>
        <el-col :span="8">
...
<script>
import { addDevice } from '@/api/edc/edc'
...
export default {
  ...
  methods: {
    ...
    save() {
      const { monitorFlag, eqpModelId, alarmName, alarmCode, eqpModelName } = this.addList
      const parmas = {
        monitorFlag,
        alarmName,
        eqpModelId,
