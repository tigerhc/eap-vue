<!--<template>-->
  <!--<div class="app-container calendar-list-container">-->
    <!--<div class="filter-container">-->
      ...
      <!--<el-input v-model="listQuery.lotNo" style="width: 200px;" class="filter-item" placeholder="请输入批次" @keyup.enter.native="handleFilter"/>-->

      <!--&lt;!&ndash; <el-select v-model="listQuery.eqpModelName" filterable style="width: 200px;" class="filter-item" placeholder="请选择设备类型">-->
        <!--<el-option-->
    ...
    <!--&gt;-->
      ...
      <!--<el-table-column align="center" label="设备号" width="150px">-->
        ...
        <!--</template>-->
      <!--</el-table-column>-->
      <!--&lt;!&ndash; <el-table-column align="center" label="设备类型">-->
        <!--<template slot-scope="scope">-->
      ...
      <!--<el-table-column align="center" label="批次产量">-->
        <!--<template slot-scope="scope">-->
          <!--<span>{{ scope.row.lotYield }}</span>-->
        <!--</template>-->
      <!--</el-table-column>-->
  ...
  <!--methods: {-->
    ...
    <!--changeParams(obj) {-->
      <!--const params = {-->
        ...
        <!--'queryFields': 'id,eqpId,alarmName,alarmCode,eqpModelName,eqpModelName,startDate,endDate,createDate,lotNo,lotYield,'-->
      <!--}-->
      <!--return params-->
    <!--},-->
    <!--getDevice() {-->
