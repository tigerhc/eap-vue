<template>
  <div class="app-container calendar-list-container">
    <w-table v-bind="table" url="/dsk/edcdsklogrecipe" sort="happenDate.desc" >
      ...
      <w-table-col name="happenDate" label="发生时间" width="200" align="center" sort="1" query querymode="date" condition="between"/>
