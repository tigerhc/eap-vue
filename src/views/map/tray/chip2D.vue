<template>
  <div class="app-container">
    <div :style="{left:'1500px',width:450+250*(dbcbLine.length-1)+'px'}" class="line_panel">
    ...
    <div :style="{width:200+250*(igbtLine1.length-1)+'px'}" class="line_panel">
    ...
    <div :style="{width:200+250*(igbtLine2.length-1)+'px'}" class="line_panel">
    ...
    <div :style="{width:200+250*(igbtLine3.length-1)+'px'}" class="line_panel">
    ...
    <div :style="{width:200+250*(igbtLine4.length-1)+'px'}" class="line_panel">
    ...
    <div :style="{width:200+250*(igbtLine5.length-1)+'px'}" class="line_panel">
    ...
    <div :style="{width:200+250*(igbtLine6.length-1)+'px'}" class="line_panel">
    ...
    <div :style="{left:'250px',width:450+250*(igbtLine6.length-1)+'px'}" class="line_panel">
    ...
    <div :style="{left:'250px',width:200+250*(igbtLine6.length-1)+'px'}" class="line_panel">
    ...
    <div :style="{left:'2250px',width:'3060px'}" class="line_panel"><!--200+250*(dbctLine.length-1)+'px'-->
      ...
      <div :style="{top:'-2150px',height:'2500px',width:250+250*(otherData.length-1)+'px'}" class="other_panel">
        <div class="incloud"/>
