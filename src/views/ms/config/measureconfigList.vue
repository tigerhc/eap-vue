<template>
  <div class="app-container calendar-list-container">
    <w-table v-slot="{row}" v-bind="table" url="/ms/msmeasureconfig" sort="create_date.asc" >
      <w-table-col name="eqpModelName" label="设备型号" sort query dict url="/ms/msmeasureconfig/eqpModelName" condition="like" fixed align="left" handler="view"/>
      <w-table-col name="processNo" label="工序" align="left"/>
