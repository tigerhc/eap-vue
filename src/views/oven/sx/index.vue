...
export default {
  ...
  data() {
    return {
      ...
      localResult56GI: [{ value: 'pinf2f', label: '横筋间距' }, { value: 'pinf', label: '正面弯曲' }, { value: 'pins', label: '侧面弯曲' }, { value: 'burr_f', label: '毛刺' }],
...
.simCDtl{background:url(../../../assets/img/c21.png);background-repeat:no-repeat;background-size: 255px 282px;height: 290px;width: 260px;position: absolute;left: 65%;top: 42%;}
